...
$FULLPATH -x $kanute_dir/inputs/tinyGenome -U $kanute_dir/inputs/single_read_1.fastq | samtools view -S  - | cut -f1,2,3,4,6 > $kanute_dir/outputs/$NAME/$VERSION/$TEST_OUT_NAME
